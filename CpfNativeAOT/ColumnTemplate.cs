                ...
                {
                    {
                        ...
                        (s, e) => SetCheck((s as CheckBox).IsChecked)
                    }
                }
            });
                ...
                {
                    {
                        ...
                        new LinearGradientFill
                        {
                            ...
                            GradientStops =
                            {
                                new GradientStop("227,247,255", 0),
                                new GradientStop("175,224,245", 1)
                            }
                        }
                    },
                    {
                ...
                {
                    {
                        ...
                        new LinearGradientFill
                        {
                            ...
                            GradientStops =
                            {
                                new GradientStop("188,228,249", 0),
                                new GradientStop("140,207,241", 1)
                            }
                        }
                    },
                    {
